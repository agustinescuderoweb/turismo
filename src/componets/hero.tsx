  ...
  return (
    ...
    <div className='flex flex-col lg:flex-row w-full mt-24'>
         ...
         <div className='w-full lg:w-[550px]'>
          ...
          <p className='text-sm lg:text-base m-4'>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Assumenda quaerat fuga, dolorem ratione debitis,
             at beatae rem iure explicabo, praesentium quasi unde aliquid voluptatem ipsa dicta! 
             Exercitationem dolorum eum voluptatem?</p><p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Possimus inventore, quia tenetur dolor error beatae voluptas magni suscipit optio corrupti vel libero ipsam numquam adipisci accusantium cumque voluptatem nobis odio.</p>
